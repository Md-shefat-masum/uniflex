...
import all from './services/accounts/all';
import details from './services/accounts/details';
import soft_delete from './services/accounts/soft_delete';
import store from './services/accounts/store';
import { responseObject } from '../../common_types/object';
import update from './services/accounts/update';
import restore from './services/accounts/restore';
import destroy from './services/accounts/destroy';
import block from './services/accounts/block';
import data_import from './services/accounts/import';
