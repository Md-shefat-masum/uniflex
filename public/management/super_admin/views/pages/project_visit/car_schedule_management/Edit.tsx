                                ...
                                <div>
                                    ...
                                    <div className="form_auto_fit">
                                        <div className="form-group form-vertical">
                                            <Input name={"date"} label="Date" value={moment(get_value('date')).format('YYYY-MM-DD')} type="date" />
                                        </div>

                                        <div className="form-group form-vertical">
                                            <Input name={"time"} label="time" value={moment(get_value('date')).format('hh:mm')} type="time" />
                                        </div>

                                        <div className="form-group form-vertical">
                                            <Input name={"location"} type="text" value={get_value('location')} />
                                        </div>
                                    </div>
                                </div>
